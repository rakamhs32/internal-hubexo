...
function exclude_country_redirect_from_rocket_cache($excluded_handles) {
    $excluded_handles[] = 'country-redirect';
    return $excluded_handles;
}
add_filter('rocket_exclude_js', 'exclude_country_redirect_from_rocket_cache');


// Enqueue scripts
function hubexo_enqueue_search_scripts() {
	wp_enqueue_script( 'hubexo-search', get_template_directory_uri() . '/assets/js/search.js', false, false, false );
    wp_enqueue_script(
        'country-redirect',
        get_template_directory_uri() . '/assets/js/header-script.js',
        array(), // dependencies
...
function modify_search_query( $query ) {
	if ( $query->is_search && ! is_admin() && $query->is_main_query() ) {
		...
		$query->set( 'post_type', array(
			...
			'post-media',
			'page'
		) ); // Include your custom post types
	}
