...
<div class="content-panel link-list white-text plum-bg fade-in-stagger <?= $BlockCss; ?>"
                        ...
                        <div class="no-link">
							...
							<?php if ( ! empty( $link ) ): ?>
                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                     xmlns="http://www.w3.org/2000/svg" class="link-list--arrow">
                                    <rect width="60" height="60" rx="30" fill="#DCFF3C"/>
                                    <path d="M40.5579 26.481L26.4824 40.5564" stroke="#321432" stroke-width="9.95285"
                                          stroke-miterlimit="10"/>
                                    <path d="M26.4761 19.4435L40.5516 33.519" stroke="#321432" stroke-width="9.95285"
                                          stroke-miterlimit="10"/>
                                </svg>
							<?php endif; ?>
