...
if ( $bannerBg && $bannerBg != "none" ) {
	get_template_part( "blocks/hero-banner/pattern-hero-banner" );
} else {
    ...
    <div class="hero-banner plum-bg header-pad-two <?= $BlockCss; ?>" data-country="<?= esc_attr( $countries ) ?>"
         id="<?= $BlockId; ?>">
		...
		<?php if ( $image ): ?>
            <div class="hero-banner--image <?= $use_mask ? "use-mask" : '' ?>">
