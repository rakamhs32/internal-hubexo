...
<div class="content-panel half-space logo-carousel white-bg fade-in <?= $BlockCss; ?>"
	...
	<?php if ( ! empty( $logos ) ): ?>
        <div class="splide logo-slider grid <?php if ( ! empty( $showRegions ) ): ?>has-titles<?php endif; ?>"
             id="logo-carousel">
                ...
                <ul class="splide__list grid">
					<?php for ( $i = 0; $i < 4; $i ++ ): ?>
						<?php foreach ( $logos as $logo ):
							...
							?>
                            <li class="splide__slide grid <?php if ( ! empty( $showRegions ) && ! empty( $region ) ): ?>has-title<?php endif; ?>">
